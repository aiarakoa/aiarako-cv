  ...
  return (
    ...
    >
      <span className="label-default">
        <span className="laptop-span">{props.article.navLinkDescription}</span>
        <span className="mobile-span">{props.article.mobileNavLinkDescription}</span>
      </span>
